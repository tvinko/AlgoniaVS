...
;(function(flowdesigner) {
    ...
    function node(diagram, settings)
    {
        ...
        this.settings = $.extend({
            ...
            color: node.color,       // background color of node
            ...
            elementProperties: settings.elementProperties,
        }, settings);
    ...
    /**
     * Set/change label color of node.
     *
     * @param   string              label color           Label color to set.
     */
    node.prototype.setLabelColor = function(color) {
        this.label.style.fillColor = color;
    }
    ...
    node.prototype.render = function(pos)
    {
        ...
        this.node.onPreMouseDown = function(event) {
            if (me.onPreMouseDown != null)
                me.onPreMouseDown(event);
        }
